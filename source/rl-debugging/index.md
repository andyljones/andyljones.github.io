...
3. **One action, zero-then-one observation, *two* timesteps long, +1 reward at the end**: If my agent can learn the value in (1.) but not this one, it must be that my reward discounting is broken.
